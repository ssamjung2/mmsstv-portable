...
> **Historical record, not maintained.** This is an analysis of `tests/test_modes/` from early 2026. It describes the project at that time and the code has changed since. What changed and when is summarised in [CHANGELOG.md](../../CHANGELOG.md); for current documentation see [the documentation index](../README.md).
>
...
> - The alt_color_bars figures refer to [the VIS decoder validation report](vis-decoder-validation-report.md), whose source files are not in the repository.
