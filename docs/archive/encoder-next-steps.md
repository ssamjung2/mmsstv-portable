...
> **Historical record, not maintained.** This is a next-steps plan from January 30, 2026. It describes the project at that time and the code has changed since. What changed and when is summarised in [CHANGELOG.md](../../CHANGELOG.md); for current documentation see [the documentation index](../README.md).
>
> Corrections (2026-09-18, checked against the code, MMSSTV and the SSTV Handbook):
>
> - Instead of relying only on external decoders, the project went on to build its own decoder. The current test suite (9 registered CTest tests, all passing on 2026-09-18) is described in [the test suite](../../tests/README.md).
