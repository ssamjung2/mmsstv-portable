...
> - Current status: [decoder status](../specs/decoder-status.md).
...
- SSTV standard: SSTV modes documented in [the porting analysis](../plans/porting-analysis.md)
- DSP filters: [the DSP primitives guide](../specs/dsp-primitives.md)
