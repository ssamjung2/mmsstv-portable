...
> **Historical record, not maintained.** This is a change summary from February 19, 2026. It describes the project at that time and the code has changed since. What changed and when is summarised in [CHANGELOG.md](../../CHANGELOG.md); for current documentation see [the documentation index](../README.md).
>
> Corrections (2026-09-18, checked against the code, MMSSTV and the SSTV Handbook):
>
> - HBPF starts at 1100 Hz, not 1080 Hz. With att = 20 the Kaiser design reduces to a rectangular window; the measured worst stop band is about 25–28 dB, not 60 dB. See [the filter specifications](../specs/filters.md).
> - There is no LPF ahead of the band-pass, and the ×32 stage after the AGC is a hard limiter, not a gain. The current decoder front end is: clip at ±24576, 2-tap average, FIR band-pass (HBPFS 400–2500 Hz before VIS, HBPF 1100–2600 Hz after), CLVL AGC, ×32 hard limiter, then CIIRTANK detectors at 1080/1200/1320/1900/2100 Hz and a Hilbert-transform FM demodulator for the picture. See [the decoder specification](../specs/decoder.md).
> - Line numbers are out of date; see [the band-pass and AGC guide](../specs/bpf-and-agc.md) for the current code.
