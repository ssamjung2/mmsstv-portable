...
> **Historical record, not maintained.** This is a DSP test report from February 5, 2026. It describes the project at that time and the code has changed since. What changed and when is summarised in [CHANGELOG.md](../../CHANGELOG.md); for current documentation see [the documentation index](../README.md).
>
...
> - CIIRTANK's third parameter is the bandwidth in Hz (Q = centre / bandwidth); the decoder's detectors use 80 or 100 Hz. Measured responses are in [the filter specifications](../specs/filters.md).
...
- Document expected performance in [the DSP primitives guide](../specs/dsp-primitives.md)
...
3. **Document results** in updated [the DSP primitives guide](../specs/dsp-primitives.md)
4. **Integration testing** with full SSTV RX decoder pipeline (optional Phase 2)

---

*Generated: February 5, 2026*  
*Reference: [the DSP primitives guide](../specs/dsp-primitives.md)*
