...
> **Historical record, not maintained.** This is an encoder timing-fix report from January 30–31, 2026. It describes the project at that time and the code has changed since. What changed and when is summarised in [CHANGELOG.md](../../CHANGELOG.md); for current documentation see [the documentation index](../README.md).
>
