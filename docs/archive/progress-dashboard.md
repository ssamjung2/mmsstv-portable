...
> **Historical record, not maintained.** This is a progress dashboard from February 5, 2026. It describes the project at that time and the code has changed since. What changed and when is summarised in [CHANGELOG.md](../../CHANGELOG.md); for current documentation see [the documentation index](../README.md).
>
> Corrections (2026-09-18, checked against the code, MMSSTV and the SSTV Handbook):
>
> - The figures here are out of date: the decoder handles all 43 modes and the DSP reference tests pass 17/17. The current test suite (9 registered CTest tests, all passing on 2026-09-18) is described in [the test suite](../../tests/README.md).
> - Open work is tracked in [the production roadmap](../plans/production-roadmap.md).
...
**Documentation:**
- Full analysis: [the porting analysis](../plans/porting-analysis.md)
- Detailed plan: [the plan review](../plans/plan-review.md) ← YOU ARE HERE
- RX progress: [docs/RX_DECODER_PROGRESS.md](decoder-prototype-progress.md)
- DSP guide: [the DSP primitives guide](../specs/dsp-primitives.md)
