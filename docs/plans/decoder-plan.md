...
> **Historical record, not maintained.** This is the decoder porting plan from February 5, 2026. It describes the project at that time and the code has changed since. For current documentation see [the documentation index](../README.md).
>
> Corrections (2026-09-18, checked against the code, MMSSTV and the SSTV Handbook):
>
> - This plan has been carried out. The decoder API is in `include/sstv_decoder.h`; see [the decoder specification](../specs/decoder.md) for how it works and [decoder status](../specs/decoder-status.md) for what is and isn't ported.
