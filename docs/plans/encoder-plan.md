...
> **Historical record, not maintained.** This is the encoder-only porting plan from January 28, 2026. It describes the project at that time and the code has changed since. For current documentation see [the documentation index](../README.md).
>
> Corrections (2026-09-18, checked against the code, MMSSTV and the SSTV Handbook):
>
> - The library now also has a decoder; see [the decoder specification](../specs/decoder.md) and [decoder status](../specs/decoder-status.md).
