...
> **Historical record, not maintained.** This is the porting analysis from January 28, 2026. It describes the project at that time and the code has changed since. For current documentation see [the documentation index](../README.md).
>
> Corrections (2026-09-18, checked against the code, MMSSTV and the SSTV Handbook):
>
> - For where each part of the library comes from in MMSSTV, with line numbers, see [the MMSSTV source map](../specs/mmsstv-source-map.md).
