...
| VIS sync modes 0, 1, 2, 9 | `sstv.cpp:1889–2125` | VIS state machine | Ported with looser acceptance (see [DECODER_STATUS.md](DECODER_STATUS.md)) |
...
[FILTER_IMPLEMENTATION_VERIFICATION.md](FILTER_IMPLEMENTATION_VERIFICATION.md).
...
- **VIS tones**: MMSSTV transmits 1100 Hz = 1, 1300 Hz = 0 (`Main.cpp`,
  ...
  [FREQUENCY_ANALYSIS.md](FREQUENCY_ANALYSIS.md).
