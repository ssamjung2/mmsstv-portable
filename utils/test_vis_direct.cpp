...
int main() {
    ...
    printf("Robot 36 VIS (0x88 = 0b10001000, sent LSB-first: 00010001) expected frequencies\n");
    printf("(MMSSTV / SSTV Handbook: 1 = 1100 Hz, 0 = 1300 Hz; bit 7 is the parity bit):\n");
    printf("Bits 0-2: 0 -> 1300 Hz\n");
    printf("Bit 3:    1 -> 1100 Hz\n");
    printf("Bits 4-6: 0 -> 1300 Hz\n");
    printf("Bit 7 (parity): 1 -> 1100 Hz\n\n");
    ...
    for (int i = 0; i < 50000; i++) {
        ...
        if (freq != last_freq) {
            ...
            if (sample < 13230) snprintf(purpose, sizeof(purpose), "Leader 1");
                ...
                snprintf(purpose, sizeof(purpose), "Bit %d = %.0f", bit_num, (freq == 1100.0) ? 1.0 : 0.0);
